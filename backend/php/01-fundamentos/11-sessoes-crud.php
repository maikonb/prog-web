<?php
  ...
  {
    global $emEdicao, $pessoaEmEdicao;
    if ($emEdicao) {
  ...
  function adicionarPessoa($dadosPessoa) {
    global $pessoas;
  ...
  function empacotaDadosFormulario() {
    $dados = [];
    ...
    switch($acao) {
      ...
      case "Cadastrar": 
        if ( validaDadosFormulario() ) {
          $dadosPessoa = empacotaDadosFormulario();
